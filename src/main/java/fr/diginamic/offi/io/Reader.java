...
/**
 * Classe qui extrait les produits du fichier CSV
 * 
...
public class Reader {
	...
	public List<Produit> getProduits() {
		...
		lignes.forEach(ligne -> produits.add(tranformeLigneEnProduit(ligne)));
		return produits;
	}
	...
	private Set<Allergene> transformeChaineEnAllergenes(String chaine) {
		...
		morceaux.forEach(nom -> allergenes
				.add(new Allergene(nom.toUpperCase().substring(0, 1) + nom.toLowerCase().substring(1))));
		return allergenes;
	}
